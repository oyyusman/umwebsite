        ...
        <div class="card mb-4 border-0 shadow-sm rounded-3" >
            <div class="card-body">
                ...
                $features_data="";
                 ...
                 $features_data .="<span class='badge bg-light rounded-pill text-dark text-wrap me-1 mb-1'>
                 $fea_row[name]
                 </span>";
                ...
                $facilities_data .="<span class='badge bg-light rounded-pill text-dark text-wrap me-1 mb-1'>
                $fac_row[name]
                </span>";
                }
                echo<<< facilities
                ...
                echo<<<area
                    <div class= " mb-3">
                           <h6 class="mb-1">Area</h6>
                            <span class='badge bg-light rounded-pill text-dark text-wrap me-1 mb-1'>
